-- Critical Security Fix: Database function search paths and missing RLS policies
...
-- Enable RLS and add policies for tp_approval_steps table
ALTER TABLE tp_approval_steps ENABLE ROW LEVEL SECURITY;

-- Drop existing policies if they exist
DROP POLICY IF EXISTS "Users can view approval steps for accessible workflows" ON tp_approval_steps;
DROP POLICY IF EXISTS "Approvers can update their assigned steps" ON tp_approval_steps;
