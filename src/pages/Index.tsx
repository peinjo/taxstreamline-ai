...
const Index = () => {
  return <div className="min-h-screen bg-gradient-to-b from-background to-gray-50">
      {/* Hero Section */}
      <div className="container mx-auto px-4 pt-20 pb-16">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">Prepare your tax return in minutes. We calculate, prepare, and guide; you file.</p>
